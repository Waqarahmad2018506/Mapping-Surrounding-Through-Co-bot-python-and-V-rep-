...
visionSensorHandleReturnCode, visionSensorHandle = sim.simxGetObjectHandle(clientID, 'cam1', sim.simx_opmode_oneshot_wait)

pioneerHandleReturnCode, pioneerHandle = sim.simxGetObjectHandle(clientID, 'Pioneer_p3dx', sim.simx_opmode_oneshot_wait)

# Setup visionSensorValues
visionSensorReturnCode, visionSensorDetectionState, visionSensorAuxPackets = sim.simxReadVisionSensor(clientID, visionSensorHandle, sim.simx_opmode_streaming)
pioneerVelocityReturnCode, pioneerVelocityLinearVelocity, pioneerVelocityAngularVelocity = sim.simxGetObjectVelocity(clientID, pioneerHandle, sim.simx_opmode_streaming)
...
while (time.time() - t) < 600:
    ...
    visionSensorReturnCode, visionSensorDetectionState, visionSensorAuxPackets = sim.simxReadVisionSensor(clientID, visionSensorHandle, sim.simx_opmode_buffer)
    pioneerVelocityReturnCode, pioneerVelocityLinearVelocity, pioneerVelocityAngularVelocity = sim.simxGetObjectVelocity(clientID, pioneerHandle, sim.simx_opmode_buffer)
    ...
    errorCode = sim.simxSetJointTargetVelocity(clientID, left_motor_handle, leftMotorVelocity, sim.simx_opmode_streaming)
    errorCode = sim.simxSetJointTargetVelocity(clientID, right_motor_handle, rightMotorVelocity, sim.simx_opmode_streaming) 
